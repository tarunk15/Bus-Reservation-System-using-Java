...
public class BusReservationSystem {
    ...
    String Username,Password,yn,search,again,choice;
    ...
    for(int i=1;i<4;){
    	...
    	if(Username.equals("1") && Password.equals("1")){
    		...
    		for(int x=1; x==1;){
    			...
    			System.out.println("**      [4] Final Bus Reservation Details   **");
    			...
    			for(x=1; x==1;){
					...
					if (choice.equals("1"))
    					...
    					System.out.println("***************************************");
					System.out.println("** 1.)DADAR        | Rs. 100  |   "+available[1]+"   **");
    					System.out.println("** 2.)KALYAN       | Rs. 350  |   "+available[2]+"   **");
    					System.out.println("** 3.)DOMBIVLI     | Rs. 300  |   "+available[3]+"   **");
    					System.out.println("** 4.)THANE        | Rs. 250  |   "+available[4]+"   **");
    					System.out.println("** 5.)KHOPOLI      | Rs. 500  |   "+available[5]+"   **");
    					System.out.println("***************************************");
					System.out.println("***************************************\n");
...
//    						}
    					...
    					String dest[] = { " ", "DADAR","KALYAN" ,"DOMBIVLI","THANE","KHOPOLI" };
    					double fare[] = { 0,100,350,300,250,500};
